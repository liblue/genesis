...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
				<form action="{{url('admin/article/notice')}}" method="get">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a href="javascript:;" onclick="delAll()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
                                 @endif
                               <!--@if(in_array('公告添加',$role))-->
                                     <a class="btn btn-primary radius" data-title="添加文章" _href="article-add.html"  href="{{url('admin/article/create')}}"><i class="Hui-iconfont">&#xe600;</i> 添加公告</a>
                                        <!--@endif-->
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					<thead  class="header">
						<tr class="text-c">
							...
							<th width="40">点赞次数</th>
                                                        <th width="40">评论</th>
                                                         @if(in_array('公告下架',$role) || in_array('公告删除',$role) )    
							<th width="120">操作</th>
                                                        @endif
						</tr>
					</thead>
	...
	<td class="f-14 td-manage">
            ...
            @if($value->is_stop=="已启用")
					 ...
					 @endif
                                    ...
                                    <a style="text-decoration:none" class="ml-5"  href="{{url('admin/article/'.$value->id.'/edit')}}" title="编辑">
...
<script type="text/javascript">
     ...
     @if(in_array('公告下架',$role) || in_array('公告删除',$role) || in_array('公告修改',$role ) ) 

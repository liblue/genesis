			...
			<dt  class="selected"><i class="Hui-iconfont">&#xe62d;</i> 管理员管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				...
				<ul>
					<li><a href="{{url('admin/ma_admin')}}" title="管理员列表">管理员列表</a></li>
                                        <li   class="current"><a href="{{url('admin/ma_admin/create')}}" title="管理员列表">添加管理员</a></li>
		</ul>
	</dd>
</dl>
...
<!--	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<article class="cl pd-20">
                    <form action="{{url('admin/ma_admin')}}" method="post" class="form form-horizontal" id="form-admin-add" onsubmit="return confirm()"  >
          {{ csrf_field() }}
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               ...
               <div class="row cl">
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>账户名：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
           ...
           <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                            ...
                            <dl class="permission-list"  id="rolelist">
					...
					<dd>
							...
							<dd>
								<label class="">
									<input type="checkbox" value="用户查看" checked name="role[]" id="user-Character-0-1-0">
									查看</label>
								<label class="">
									<input type="checkbox" value="用户禁用" name="role[]" id="user-Character-0-1-1">
									禁用</label>
                                                            <label class="">
						...
						<dl class="cl permission-list2">
							...
							<dd>
                                                            <label class="">
									<input type="checkbox" value="公告查看" checked  name="role[]" id="user-Character-0-0-0">
									查看</label>
								<label class="">
							...
							<dd>
                                                            <label class="">
									<input type="checkbox" value="文章查看" checked  name="role[]" id="user-Character-0-0-0">
									查看</label>
                                                            
								<label class="">
									<input type="checkbox" value="文章删除" name="role[]" id="user-Character-0-0-0">
									删除</label>
                                                             <label class="">
									<input type="checkbox" value="文章下架" name="role[]" id="user-Character-0-0-0">
									下架</label>
							</dd>
						</dl>
                                                <dl class="cl permission-list2">
							...
							<dd>
                                                            <label class="">
									<input type="checkbox" value="评论查看" checked  name="role[]" id="user-Character-0-0-0">
									查看</label>
                                                            
								<label class="">
									<input type="checkbox" value="评论删除" name="role[]" id="user-Character-0-0-0">
									删除</label>
							...
							<dt>
							 ...
							 <dd>
								<label class="">
                                                                    <input type="checkbox" value="部门查看" checked name="role[]" id="user-Character-0-0-0">
                                                                    查看
                                                                </label>
                                                                <label class=""><input type="checkbox" value="部门添加" name="role[]" id="user-Character-0-0-0">
                                                                    添加</label>
								<label class=""><input type="checkbox" value="部门删除" name="role[]" id="user-Character-0-0-0">
                                                                    删除</label>
                                                             <label class=""><input type="checkbox" value="部门修改" name="role[]" id="user-Character-0-0-0">
                                                                    修改</label>
							</dd>
						</dl>
                                            <dl class="cl permission-list2">
							<dt>
							 ...
							 <dd>
								<label class="">
                                                                    <input type="checkbox" value="角色查看" checked name="role[]" id="user-Character-0-0-0">
                                                                    查看
                                                                </label>
                                                                <label class=""><input type="checkbox" value="角色添加" name="role[]" id="user-Character-0-0-0">
                                                                    添加</label>
								<label class=""><input type="checkbox" value="角色删除" name="role[]" id="user-Character-0-0-0">
                                                                    删除</label>
                                                             <label class=""><input type="checkbox" value="角色修改" name="role[]" id="user-Character-0-0-0">
                                                                    修改</label>
							</dd>
						</dl>
...
function checkAccount(account){
   var reg = /^[a-zA-Z]([-_a-zA-Z0-9]{5,16})$/;
    if(reg.test(account)){
        return "3" ;
    }  
    return "2"; 

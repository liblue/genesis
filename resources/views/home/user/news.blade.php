    		...
    		<aside>
    	 	...
    	 	<ul>
    	  	...
    	  	<div  class="userinfo  news">
    	  		...
    	  		<div class="myart">
    	  			<p id="userinfo_head2" class="currenthead">未读消息</p>
                                
                                <a href="{{url('user/readed_news')}}"> <p id="userinfo_head2" >全部消息</p></a>
    	  		</div>
	   	  ...
	   	  <ul>
                      ...
                      @if(count($news))
                      <li class="button ">
                          <button class="setyidu" onclick="setyidu(this)"></button>
                     </li>
                     @endif
...
<!--	   		
	   		<li>	 
	   			<div class="com_head">
	   				<a  class="user_thumb"><img src="{{asset('home/img/main/user_thumb.png')}}" /></a>
  ...
  <footer>
   ...
   <script>
    function  login(){               
        ...
        function setyidu(obj){
            
         
             $(obj).parent().parent().remove(); 
               $.post("{{url('setyidu')}}",{'_token':'{{csrf_token()}}','id':1},function(data){
